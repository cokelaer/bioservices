...
def test_version(bigg):
    ...
    assert keys_exists(version, ("bigg_models_version", "api_version", "last_updated"))
...
def test_models(bigg):
    ...
    assert keys_exists(models[0], ("bigg_id", "metabolite_count", "organism", "reaction_count", "gene_count"))
...
def test_metabolites(bigg):
    ...
    assert keys_exists(metabolites[0], ("bigg_id", "model_bigg_id", "organism", "name", "compartment_bigg_id"))
...
def test_reactions(bigg):
    ...
    assert keys_exists(reactions[0], ("bigg_id", "model_bigg_id", "organism", "name"))
...
def test_genes(bigg):
    ...
    assert keys_exists(genes[0], ("bigg_id", "model_bigg_id", "organism", "name"))
...
def test_search(bigg):
    ...
    assert keys_exists(models[0], ("bigg_id", "organism", "metabolite_count", "gene_count", "reaction_count"))
