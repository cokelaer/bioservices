...
def test_Ortho(biodbnet):
    df = biodbnet.dbOrtho("Gene Symbol", "Gene ID", ["MYC", "MTOR", "A1BG"], input_taxon=9606, output_taxon=10090)
...
def test_dbwalk(biodbnet):
    biodbnet.dbWalk("Ensembl Gene ID->Gene ID->Homolog - Mouse Gene ID->Ensembl Gene ID", "ENSG00000121410", 9606)
