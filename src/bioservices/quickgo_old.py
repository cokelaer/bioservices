...
class QuickGO_old(REST):
    ...
    .. doctest::
        ...
        >>> from bioservices import QuickGO_old
        >>> s = QuickGO_old()
    ...
    def __init__(self, verbose=False, cache=False):
        ...
        """
        super(QuickGO_old, self).__init__(url="http://www.ebi.ac.uk/QuickGO-Old",
...
class GeneOntology():
    ...
    def __init__(self):
        self._quickgo = QuickGO_old(verbose=False)
