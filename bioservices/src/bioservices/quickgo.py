...
.. topic:: What is quickGO
    ...
    :URL: http://www.ebi.ac.uk/QuickGO/WebServices.html
    ...
    def Annotation(self, goid=None, protein=None, format="gaf", limit=10000, 
        ...
        .. note:: 
            ...
            * The file will be gzipped if the gz parameter is supplied. 
            ...
            >>> print g.Annotation(protein='P12345', format='tsv', col="ref,evidence",ref='PMID:*')
            >>> print g.Annotation(protein='P12345,Q4VCS5', format='tsv', col="ref,evidence",ref='PMID:,Reactome:')

        http://www.ebi.ac.uk/QuickGO/GAnnotation?protein=P12345,Q4VCS5&format=tsv&col=proteinID,proteinSymbol,evidence,goID,goName,aspect,ref,with,from');
