...
Here is a ipython notebook dedicated to ArrayExpress (now hosted on BioStudies), which can be
downloaded :download:`notebooks/ArrayExpress.ipynb` or view its results on
`arrayexpress nbviewer <https://nbviewer.org/github/cokelaer/bioservices/blob/main/doc/notebooks/ArrayExpress.ipynb>`_
